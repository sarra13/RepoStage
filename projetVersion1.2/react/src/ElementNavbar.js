  ...
  render()
      ...
      >
                ...
                <SideNav.Nav >
                            ...
                            <Link className="lien" to="/admin"> <i className="fa fa-fw fa-cogs" style={{ fontSize: '1.75em' }}
                                 /></Link>
                            </NavIcon>
...
<NavItem hidden={this.state.expanded} onClick={this.onToggle.bind(this)}>
                            <NavIcon >
...
/>          
                        ...
                        <Link onClick={this.deverrouiller.bind(this)} ><i className="fa fa-fw fa-unlock" style={{ fontSize: '1.75em' }}
                             /></Link>
                        </NavIcon>
                        <NavText style={{ paddingRight: 32 }}>
                        <Link onClick={this.deverrouiller.bind(this)} >Déverrouiller </Link>
                          ...
                          <Link onClick={this.verrouiller.bind(this)} > <i className="fa fa-fw fa-lock" style={{ fontSize: '1.75em' }}
                               /></Link>
                          </NavIcon>
                          <NavText style={{ paddingRight: 32 }}>
                    ...
                    <NavItem eventKey="/" >
                        ...
                        <Link className="lien" to="/" > <i className="fa fa-fw fa-home" style={{ fontSize: '1.75em' }}
                             /></Link>
                        </NavIcon>
                        <NavText style={{ paddingRight: 32 }}>
                    ...
                    <NavItem >
                        ...
                        <Link className="lien" to="/etudiant">  <i className=" fa fa-fw fa-user" style={{ fontSize: '1.75em',zoom:2 }} /></Link>
                        </NavIcon>
                        <NavText style={{ paddingRight: 32 }}>
                    ...
                    <NavItem>
                        <NavIcon>
                            ...
                            <Link className="lien" to="/competences"><i className="  fa fa-fw   fa-check" style={{ fontSize: '1.75em' }}  /></Link> 
                    ...
                    <NavItem  eventKey="/synthese">
                        ...
                        <Link className="lien" to="/synthese"> <i className=" fa fa-fw fa-globe" style={{ fontSize: '1.75em' }} /></Link>
                        </NavIcon>
                        <NavText style={{ paddingRight: 32 }}>
                    ...
                    <NavItem  eventKey="/stages">
                        ...
                        <Link className="lien" to="/stages"> <i className="fa fa-medkit" style={{ fontSize: '1.75em' }} /></Link>
                        </NavIcon>
                        <NavText style={{ paddingRight: 32 }}>
